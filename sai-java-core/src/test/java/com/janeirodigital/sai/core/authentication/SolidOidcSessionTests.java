...
import static com.janeirodigital.sai.core.authentication.SolidOidcSession.*;
...
class SolidOidcSessionTests {
    ...
    static void beforeAll() throws SaiException {
        ...
        mockOnGet(dispatcher, "/alice/id", "authentication/alice-webid-ttl");
        mockOnGet(dispatcher, "/projectron/id", "authentication/projectron-application-profile-jsonld");
        mockOnGet(dispatcher, "/op/.well-known/openid-configuration", "authentication/op-configuration-json");
        mockOnPost(dispatcher, "/op/token", "authentication/op-token-response-json");
        // Application client id document missing required fields
        mockOnGet(dispatcher, "/missing-fields/projectron/id", "authentication/projectron-application-profile-missing-fields-jsonld");
        // Webid points to provider that doesn't have DPoP support
        mockOnGet(dispatcher, "/nodpop/alice/id", "authentication/alice-webid-nodpop-ttl");
        mockOnGet(dispatcher, "/nodpop/op/.well-known/openid-configuration", "authentication/op-configuration-nodpop-json");
        // Webid points to provider thaht doesn't support webid claims
        mockOnGet(dispatcher, "/nowebid/alice/id", "authentication/alice-webid-nowebid-ttl");
        mockOnGet(dispatcher, "/nowebid/op/.well-known/openid-configuration", "authentication/op-configuration-nowebid-json");
        // Webid points to provider that doesn't support client_id claims
        mockOnGet(dispatcher, "/noclientid/alice/id", "authentication/alice-webid-noclientid-ttl");
        mockOnGet(dispatcher, "/noclientid/op/.well-known/openid-configuration", "authentication/op-configuration-noclientid-json");
        // Webid points to provider with a token endpoint that gives a network IO error
        mockOnGet(dispatcher, "/badio/alice/id", "authentication/alice-webid-badio-ttl");
        mockOnGet(dispatcher, "/badio/op/.well-known/openid-configuration", "authentication/op-configuration-badio-json");
        mockOnPost(dispatcher, "/badio/op/token", "authentication/op-token-response-badio-json");
        // Webid points to provider with a token endpoint that gives an access token of unknown type
        mockOnGet(dispatcher, "/unknown/alice/id", "authentication/alice-webid-unknown-ttl");
        mockOnGet(dispatcher, "/unknown/op/.well-known/openid-configuration", "authentication/op-configuration-unknown-json");
        mockOnPost(dispatcher, "/unknown/op/token", "authentication/op-token-response-unknown-json");
        // Request is made without an offline access scope so the token endpoint doesn't give back a refresh token
        mockOnGet(dispatcher, "/norefresh/alice/id", "authentication/alice-webid-norefresh-ttl");
        mockOnGet(dispatcher, "/norefresh/op/.well-known/openid-configuration", "authentication/op-configuration-norefresh-json");
        mockOnPost(dispatcher, "/norefresh/op/token", "authentication/op-token-response-norefresh-json");
        ...
        mockOnGet(dispatcher, "/refresh/alice/id", "authentication/alice-webid-refresh-ttl");
        mockOnGet(dispatcher, "/refresh/op/.well-known/openid-configuration", "authentication/op-configuration-refresh-json");
        mockOnPost(dispatcher, "/refresh/op/token", "authentication/op-token-response-refresh-json");
        ...
        mockOnGet(dispatcher, "/refresh-unknown/alice/id", "authentication/alice-webid-refresh-unknown-ttl");
        mockOnGet(dispatcher, "/refresh-unknown/op/.well-known/openid-configuration", "authentication/op-configuration-refresh-unknown-json");
        mockOnPost(dispatcher, "/refresh-unknown/op/token", List.of("authentication/op-token-response-refresh-unknown-1-json", "authentication/op-token-response-refresh-unknown-2-json"));
        // Request is made with an offline access scope and then a refresh is issued but an additional refresh token isn't provided
        mockOnGet(dispatcher, "/refresh-norefresh/alice/id", "authentication/alice-webid-refresh-norefresh-ttl");
        mockOnGet(dispatcher, "/refresh-norefresh/op/.well-known/openid-configuration", "authentication/op-configuration-refresh-norefresh-json");
        mockOnPost(dispatcher, "/refresh-norefresh/op/token", List.of("authentication/op-token-response-refresh-norefresh-1-json", "authentication/op-token-response-refresh-norefresh-2-json"));
    ...
    void initBuilderApplicationLookup() throws SaiException {
        SolidOidcSession.Builder builder = new SolidOidcSession.Builder();
