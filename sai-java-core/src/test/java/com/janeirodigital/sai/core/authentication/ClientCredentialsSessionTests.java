...
class ClientCredentialsSessionTests {
    ...
    void beforeEach() throws MalformedURLException {
        ...
        mockOnGet(dispatcher, "/cc/op/.well-known/openid-configuration", "authentication/op-configuration-cc-json");
        mockOnPost(dispatcher, "/cc/op/token", List.of("authentication/op-token-response-cc-json"));
