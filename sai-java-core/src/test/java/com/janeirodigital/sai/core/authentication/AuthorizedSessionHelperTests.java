...
import static com.janeirodigital.sai.core.authentication.AuthorizedSessionHelper.*;
...
import static com.janeirodigital.sai.core.utils.HttpUtils.setHttpHeader;
...
class AuthorizedSessionHelperTests {
    ...
    static void beforeAll() throws SaiException {
        ...
        mockOnGet(dispatcher, "/mismatch/.well-known/openid-configuration", "authentication/op-configuration-json");
        ...
        mockOnGet(dispatcher, "/projectron", "authentication/projectron-clientid-jsonld");
        // Protected text document
        mockOnGet(dispatcher, "/protected", "authentication/protected-txt");
        mockOnPut(dispatcher, "/protected", "http/204");
        mockOnDelete(dispatcher, "/protected", "http/204");
        // Protected Turtle document
        mockOnGet(dispatcher, "/ttl/protected", "authentication/protected-ttl");
        mockOnPut(dispatcher, "/ttl/protected", "http/204");
        // Protected JSON-LD document
        mockOnGet(dispatcher, "/jsonld/protected", "authentication/protected-jsonld");
