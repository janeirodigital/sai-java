...
class ReadableSocialAgentProfileTests {
    ...
    void reloadReadableSocialAgentProfileTurtle() throws SaiException, SaiNotFoundException {
        ReadableSocialAgentProfile profile = ReadableSocialAgentProfile.get(MockWebServerHelper.toUrl(server, "/ttl/id"), saiSession);
    ...
    private void checkProfile(ReadableSocialAgentProfile profile) throws SaiException {
