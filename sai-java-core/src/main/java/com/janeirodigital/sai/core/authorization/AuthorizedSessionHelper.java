...
public class AuthorizedSessionHelper {
    ...
    public static URL getOidcIssuerForSocialAgent(OkHttpClient httpClient, URL socialAgentId) throws SaiException {
        ...
        try (Response response = getRequiredRdfResource(httpClient, socialAgentId)) {
            ...
            throw new SaiException("Unable to get OpenID Connect provider for " + socialAgentId + ": " + ex.getMessage());
        }
    }
     ...
     * @throws SaiException
     */
    public static OIDCProviderMetadata getOIDCProviderConfiguration(URL providerUrl) throws SaiException {
        ...
        try {
            ...
            if (!issuer.equals(metadata.getIssuer())) { throw new SaiException("Issuer mismatch: Supplied issuer " + issuer.getValue() + "is a different value than that received from OP: " + metadata.getIssuer().getValue()); }
        } catch (IOException | ParseException| SaiException ex) {
            throw new SaiException("Unable to lookup OpenID Provider configuration for " + providerUrl +": " + ex.getMessage());
        }
        return metadata;
    }
     ...
     * @throws SaiException
     */
    public static Resource getClientIdDocument(OkHttpClient httpClient, URL clientId) throws SaiException {
     ...
     * @throws SaiException
     */
    public static Response getProtectedResource(AuthorizedSession authorizedSession, OkHttpClient httpClient, URL url, Headers headers) throws SaiException {
     ...
     * @throws SaiException
     */
    public static Response getProtectedResource(AuthorizedSession authorizedSession, OkHttpClient httpClient, URL url) throws SaiException {
     ...
     * @throws SaiException
     */
    public static Response getProtectedRdfResource(AuthorizedSession authorizedSession, OkHttpClient httpClient, URL url, Headers headers) throws SaiException {
        Objects.requireNonNull(authorizedSession, "Must provide an authorized session to access protected resource");
        headers = setAuthorizationHeaders(authorizedSession, GET, url, headers);
     ...
     * @throws SaiException
     */
    public static Response getProtectedRdfResource(AuthorizedSession authorizedSession, OkHttpClient httpClient, URL url) throws SaiException {
     ...
     * @throws SaiException
     */
    public static Response deleteProtectedResource(AuthorizedSession authorizedSession, OkHttpClient httpClient, URL url, Headers headers) throws SaiException {
        Objects.requireNonNull(authorizedSession, "Must provide an authorized session to access protected resource");
     ...
     * @throws SaiException
     */
    public static Response deleteProtectedResource(AuthorizedSession authorizedSession, OkHttpClient httpClient, URL url) throws SaiException {
     ...
     */
    public static Headers setAuthorizationHeaders(AuthorizedSession authorizedSession, HttpMethod method, URL url, Headers headers) throws SaiException {
