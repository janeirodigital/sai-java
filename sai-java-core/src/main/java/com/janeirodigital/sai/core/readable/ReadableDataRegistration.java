...
public class ReadableDataRegistration extends ReadableResource {
     ...
     */
    public static ReadableDataRegistration get(URL url, DataFactory dataFactory, ContentType contentType) throws SaiException, SaiNotFoundException {
        Objects.requireNonNull(url, "Must provide the URL of the readable data registration to get");
        Objects.requireNonNull(dataFactory, "Must provide a data factory to assign to the readable data registration");
        ...
        try (Response response = checkReadableResponse(getProtectedRdfResource(dataFactory.getAuthorizedSession(), dataFactory.getHttpClient(), url, headers))) {
            return new ReadableDataRegistration.Builder(url, dataFactory, contentType, getRdfModelFromResponse(response)).build();
        }
    }
     ...
     * @throws SaiNotFoundException
     */
    public static ReadableDataRegistration get(URL url, DataFactory dataFactory) throws SaiException, SaiNotFoundException {
    ...
    private static class Builder {
        ...
        public Builder(URL url, DataFactory dataFactory, ContentType contentType, Model dataset) throws SaiException, SaiNotFoundException {
            ...
            Objects.requireNonNull(dataFactory, "Must provide a data factory for the readable data registration builder");
        ...
        public ReadableDataRegistration build() throws SaiException {
            return new ReadableDataRegistration(this.url, this.dataFactory, this.dataset, this.resource, this.contentType,
