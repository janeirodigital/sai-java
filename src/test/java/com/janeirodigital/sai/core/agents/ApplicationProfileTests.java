...
class ApplicationProfileTests {
    ...
    private static final String PROJECTRON_DESCRIPTION = "Best project management ever";
    ...
    static void beforeAll() throws SaiException, SaiHttpException, SaiRdfException {
        ...
        mockOnGet(dispatcher, "/jsonld/required/projectron/id", "agents/application-profile-required-jsonld");
        mockOnPut(dispatcher, "/jsonld/projectron/id", "http/204");
        mockOnDelete(dispatcher, "/jsonld/projectron/id", "http/204");
        // Build a CRUD resource that doesn't exist and create it
        mockOnGet(dispatcher, "/new/jsonld/projectron/id", "http/404");
        mockOnPut(dispatcher, "/new/jsonld/projectron/id", "http/201");
    ...
    void createNewCrudApplicationProfile() throws SaiException {
        URI uri = toMockUri(server, "/new/jsonld/projectron/id");
    ...
    void readCrudApplicationProfile() throws SaiException, SaiHttpNotFoundException {
        URI uri = toMockUri(server, "/jsonld/projectron/id");
    ...
    void readCrudApplicationProfileRequired() throws SaiException, SaiHttpNotFoundException {
        URI uri = toMockUri(server, "/jsonld/required/projectron/id");
        ApplicationProfile profile = ApplicationProfile.get(uri, saiSession);
    ...
    void failToReadCrudApplicationProfileMissingFields() {
        URI uri = toMockUri(server, "/missing-fields/jsonld/projectron/id");
