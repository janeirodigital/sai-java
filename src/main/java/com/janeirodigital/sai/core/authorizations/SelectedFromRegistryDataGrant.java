...
public class SelectedFromRegistryDataGrant extends InheritableDataGrant {
    ...
    /**
     * Construct a {@link SelectedFromRegistryDataGrant} from the provided {@link Builder}.
     * @param builder {@link Builder} to construct with
     * @throws SaiException
     */
    protected SelectedFromRegistryDataGrant(Builder builder) throws SaiException {
        super(builder);
